...
public class Vapur extends DenizUlasimi {
    Boolean status = false;
    public Vapur(Double ucret, Integer kapasite, Integer maksimumHiz, String marka, List<String> hatGuzergah) {
    ...
    public void sefereBasla() {
        if (!getHatGuzergah().isEmpty()) {
            System.out.println("Vapur seferine başlanmıştır.");
